...
const CourseDetails = () => {
  ...
  return courseData ? (
    <div className="bg-gray-100 min-h-screen pt-24"> {/* Added padding top for navbar spacing and changed bg */}
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-20 px-8 text-left">
        ...
        {/* Right Column - Card */}
        <div className="md:w-[420px] w-full z-10 shadow-lg rounded-lg overflow-hidden bg-white sticky top-28"> {/* sticky to stay below navbar */}
          {
            playerData
              ? <YouTube videoId={playerData.videoId} opts={{ playerVars: { autoplay: 1 } }} iframeClassName='w-full aspect-video' />
